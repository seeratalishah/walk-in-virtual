...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (galleryRow) {
    galleryRow.scrollLeft = 5; // Adjust the initial scroll position as needed
  }
});
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (galleryRow) {
    galleryRow.scrollLeft = 700; // Adjust the initial scroll position as needed
  }
});
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  listItems.forEach((listItem) => {
    listItem.addEventListener("click", function (event) {
      ...
      if (icon) {
        icon.innerHTML =
          icon.innerHTML === '<i class="fa-solid fa-circle-chevron-down"></i>'
